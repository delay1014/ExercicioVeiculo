public class TesteVeiculo { 
    public static void main(String[] argumentos) {
        ...
        System.out.println("O carro foi fabricado em " + fusca.getAnoFabricacao() + " e tem " + fusca.getQuilometragem() + " quilômetros rodados.");
        ...
        System.out.println("A bicicleta tem " + caloi10.getQtMarchas() + " marchas.");
